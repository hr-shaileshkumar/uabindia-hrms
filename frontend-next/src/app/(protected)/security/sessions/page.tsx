...
export default function RefreshTokensPage() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h2 className="text-2xl font-semibold">Refresh Tokens</h2>
        <p className="text-sm text-gray-500">Active refresh token sessions.</p>
      </div>
          ...
          <table className="min-w-full text-sm">
            ...
            <tbody>
              ...
              {!loading && sessions.length === 0 && (
                <tr>
                  <td colSpan={3} className="px-4 py-6 text-center text-gray-500">No refresh tokens found.</td>
                </tr>
              )}
            </tbody>
          </table>
